...
// TODO rewrite my own version of this :D
(function($){ 	
	
	var d = $(document); 		//window object
	var h = $("head");			//head object
	var drag = null;			//reference to the current grip that is being dragged
	// TODO tables used to be an array.... why?
	 ...
	 * @param {jQuery ref} t - table object
	 */
	var createGrips = function(t, opts){	
    ...
    $.fn.extend({  
        colResizable: function(options) {           
            var defaults = {
				...
				// TODO
				tabText: null,					//an array strings that will display above each tab
